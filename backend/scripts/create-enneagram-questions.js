console.log('🚀 Starting Enneagram questions creation...');
...
async function main() {
  ...
  try {
    ...
    if (projectResult.rows.length === 0) {
      console.log('❌ Project not found, please run create-enneagram-test.js first');
      return;
    }
    ...
    console.log('🎉 Enneagram questions setup completed!');
